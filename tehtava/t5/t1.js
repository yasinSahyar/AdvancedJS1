'use strict';
import { restaurantRow, restaurantModal } from './components.js'; // UI components
import { fetchData } from './utils.js'; // Fetch utility
import { apiURL } from './variables.js'; // API base URL
